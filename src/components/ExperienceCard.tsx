...
function ExperienceCard({ experience }: Props) {
  return (
    <article className="bg-[#292929] max-h-[576px] p-4 flex snap-center flex-col rounded-lg text-left space-y-2 flex-shrink-0 w-11/12 md:w-1/3 h-full overflow-hidden">
